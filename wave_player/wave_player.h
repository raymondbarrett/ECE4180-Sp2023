...
///
/// \brief Patched wave_player from official mbed repo.

#ifndef WAVE_PLAYER_HPP
#define WAVE_PLAYER_HPP

#ifndef __cplusplus
#error "wave_player.h is a cxx-only header."
#endif // __cplusplus

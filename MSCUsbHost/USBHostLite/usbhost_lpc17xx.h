...
#define PRINT_Err(rc) \
  printf("ERROR: In %s at Line %u - rc = %d\n", __FUNCTION__, __LINE__, rc)
...
#define TD_ROUNDING \
  (USB_INT32U)(0x00040000) /* Buffer Rounding                             */
#define TD_SETUP \
  (USB_INT32U)(0) /* Direction of Setup Packet                   */
#define TD_IN \
  (USB_INT32U)(0x00100000) /* Direction In                                */
#define TD_OUT \
  (USB_INT32U)(0x00080000) /* Direction Out                               */
#define TD_DELAY_INT(x) \
  (USB_INT32U)((x) << 21) /* Delay Interrupt                             */
#define TD_TOGGLE_0 \
  (USB_INT32U)(0x02000000) /* Toggle 0                                    */
#define TD_TOGGLE_1 \
  (USB_INT32U)(0x03000000) /* Toggle 1                                    */
#define TD_CC \
  (USB_INT32U)(0xF0000000) /* Completion Code                             */
...
{ /* ----------- HostController EndPoint Descriptor ------------- */
  ...
  volatile USB_INT32U
    TailTd; /* Physical address of tail in Transfer descriptor list     */
  volatile USB_INT32U
    HeadTd; /* Physcial address of head in Transfer descriptor list     */

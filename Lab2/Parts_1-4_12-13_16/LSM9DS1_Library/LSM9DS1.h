...
class LSM9DS1
{
  ...
  */
  ...
  //    INT2_DRDY_TEMP (INT2 only) INT_FTH, INT_OVR, INT_FSS5, INT_IG_XL (INT1
  //    only), INT1_IG_G (INT1 only), INT2_INACT (INT2 only)
   ...
   * bypass Possible inputs: FIFO_OFF, FIFO_THS, FIFO_CONT_TRIGGER,
 ...
 protected:
  ...
  void
  SPIreadBytes(uint8_t csPin, uint8_t subAddress, uint8_t* dest, uint8_t count);
